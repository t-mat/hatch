...
$script_name = "libjpeg-turbo-1.3.0.ps1"
...
$cmake_url = "http://www.cmake.org/files/v2.8/cmake-2.8.11-win32-x86.zip"
...
## libjpeg-turbo 1.3.0
##
$target_url  = "http://sourceforge.net/projects/libjpeg-turbo/files/1.3.0/libjpeg-turbo-1.3.0.tar.gz/download"
$target_arc  = "$arc_path\libjpeg-turbo-1.3.0.tar.gz"
...
$target_cmake_gen = "Visual Studio 11"
$target_msbuild_opt = "libjpeg-turbo.sln /nologo /p:Configuration=Release /p:Platform=Win32"

DownloadFile $target_url $target_arc

LogBegin "Extracting $target_arc"
...
Invoke-Expression -Command "msbuild.exe $target_msbuild_opt >> $script_log 2>&1"
LogEnd
