...
##
## PortableGit 1.8.4 preview 20130916
##
$msysgit_dir = "$bin_path\msysgit"
$msysgit_bin = "$msysgit_dir\cmd\git.exe"
$msysgit_url = "http://msysgit.googlecode.com/files/PortableGit-1.8.4-preview20130916.7z"
...
LogBegin "Extracting $msysgit_arc"
rmdir -recurse $msysgit_dir >$null 2>&1
MsysGit --version
LogEnd
